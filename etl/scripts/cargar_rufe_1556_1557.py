...
DATOS_RUFES = [
    {
        "numero_rufe": "1556",
        "prioridad": "BAJA",
        "observaciones_evaluador": "Observaciones Kely: Vivienda de 3 pisos fisuras leves en mamposteria. Se recomienda reparar y anclar con acero a las columnas. Carlos Cobo.",
        "observaciones_animales": None,
        "corregimiento": None,
        "sector_barrio": "Nueva Estancia",
        "direccion": "Cra 15 #17-27",
        "personas": [
            {"nombre": "Yhoni Ramos Guerrero", "doc": "1143845918", "parentesco": "Jefe(a) o cabeza del hogar", "sexo": "M", "fecha_nac": "1999-01-16", "edad": 27, "telefono": "3175852511", "es_jefe": True},
            {"nombre": "Juan Diego Guerrero", "doc": "1109189145", "parentesco": "Hermano(a), Hermanastro(a)", "sexo": "M", "fecha_nac": "2008-11-25", "edad": 17, "telefono": "3172621774", "es_jefe": False}
        ]
    },
    {
        "numero_rufe": "1557",
        "prioridad": "BAJA",
        "observaciones_evaluador": "Observaciones Angel: Vivienda de 1 piso con una ampliacion trasera (cocina y baño con losa de teja). Requiere reparacion asentamiento de los muros de la ampliacion. Carlos Cobo.",
        "observaciones_animales": None,
        "corregimiento": None,
        "sector_barrio": "La Estancia",
        "direccion": "Carrera 15 #19-33",
        "personas": [
            {"nombre": "Angel Alberto Mendoza", "doc": "16446014", "parentesco": "Jefe(a) o cabeza del hogar", "sexo": "M", "fecha_nac": "1956-06-25", "edad": 70, "telefono": "3122526671", "es_jefe": True},
            {"nombre": "Maria Rosario Cabrera", "doc": "31919220", "parentesco": "Pareja, Esposa(o)", "sexo": "F", "fecha_nac": "1965-05-13", "edad": 61, "telefono": "3218329191", "es_jefe": False}
        ]
    }
]

def main():
    print("Iniciando procesamiento de RUFEs 1556 y 1557...")
    try:
