...
DATOS_RUFES = [
    {
        "numero_rufe": "1551",
        "prioridad": "ALTA",
        "observaciones_evaluador": "Vivienda con multiples afectaciones en paredes, cielos y techo. Se recomienda buscar un lugar donde reubicar mientras se realicen las adecuaciones ya que primeramente lo que pueda desplomarse sea el cielo razo elaborado con esterilla y cemento. Prioridad Alta.",
        "observaciones_animales": None,
        "corregimiento": None,
        "sector_barrio": "Bolivar",
        "direccion": "Calle 12 #2-37",
        "personas": [
            {"nombre": "Sandra Eugenia Zamora Franco", "doc": "31998022", "parentesco": "Jefe(a) o cabeza del hogar", "sexo": "F", "fecha_nac": "1969-08-04", "edad": 57, "telefono": "3116075405", "es_jefe": True},
            {"nombre": "Ingrid Juliana Urrea", "doc": "1193075537", "parentesco": "Hijo(a), hijastro(a)", "sexo": "F", "fecha_nac": "2001-12-10", "edad": 24, "telefono": "3122788763", "es_jefe": False}
        ]
    }
]

def main():
    print("Iniciando procesamiento de RUFE 1551...")
    try:
