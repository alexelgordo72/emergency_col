...
DATOS_RUFES = [
    {
        "numero_rufe": "1552",
        "prioridad": "BAJA",
        "observaciones_evaluador": "Observaciones Oscar: Vivienda de 1 piso adelante sin fisuras, parte trasera de 2 pisos fisuras muros. Se recomienda reparacion fisuras. Carlos Cobo.",
        "observaciones_animales": None,
        "corregimiento": None,
        "sector_barrio": "La Estancia",
        "direccion": "Calle 21 #15-40",
        "personas": [
            {"nombre": "Oscar Suarez Sandoval", "doc": "2647015", "parentesco": "Jefe(a) o cabeza del hogar", "sexo": "M", "fecha_nac": "1940-05-12", "edad": 86, "telefono": None, "es_jefe": True},
            {"nombre": "Leydi Suarez Sandoval", "doc": "1118309916", "parentesco": "Hijo(a), hijastro(a)", "sexo": "F", "fecha_nac": "1994-01-20", "edad": 32, "telefono": "3015721162", "es_jefe": False},
            {"nombre": "Stevan Suarez Sandoval", "doc": "1109933115", "parentesco": "Nieto(a)", "sexo": "M", "fecha_nac": "2015-11-19", "edad": 10, "telefono": None, "es_jefe": False}
        ]
    },
    {
        "numero_rufe": "1553",
        "prioridad": "BAJA",
        "observaciones_evaluador": "Observaciones Maria Alejandra: Apto 104 con fisuras leves plaquetas para reparacion. Carlos Cobo.",
        "observaciones_animales": None,
        "corregimiento": None,
        "sector_barrio": "Parque Pinos",
        "direccion": "Calle 27 #9A-12 Torre 22",
        "personas": [
            {"nombre": "Maria Alejandra Nuñez Barragan", "doc": "1105683936", "parentesco": "Jefe(a) o cabeza del hogar", "sexo": "F", "fecha_nac": "1992-11-30", "edad": 33, "telefono": "3217118425", "es_jefe": True}
        ]
    }
]

def main():
    print("Iniciando procesamiento de RUFEs 1552 y 1553...")
    try:
