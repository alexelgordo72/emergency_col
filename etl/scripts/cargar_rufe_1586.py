...
DATOS_RUFES = [
    {
        ...
        "corregimiento": None,
        "sector_barrio": "Fray Peña",
        "direccion": None,
        "personas": [
            {"nombre": "Maribel Berna Madrid", "doc": "31923895", "parentesco": "Jefe(a) o cabeza del hogar", "sexo": "F", "fecha_nac": "1961-08-27", "edad": 65, "telefono": "3236213869", "es_jefe": True}
        ]
    }
]

def main():
    print("Iniciando procesamiento de RUFE 1586...")
    try:
