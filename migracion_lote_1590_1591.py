...
LOTES_NUEVOS_RUFE = [
    {
        "num_formulario": "1590", "corregimiento": "San Marcos", "prioridad": "ALTA",
        "observaciones_evaluador": "Horacio Silva - Prioridad alta de intervención por daños (RUFE-1590)[cite: 47].",
        "personas": [
            {"nombre": "Horacio Silva", "doc": "94360969", "fecha": "23/08/1972", "es_jefe": True, "sexo": "M", "parentesco": "Jefe de Hogar", "etnia": "Ninguna"}
        ]
    },
    {
        "num_formulario": "1591", "corregimiento": "Yumbo", "prioridad": "ALTA",
        "observaciones_evaluador": "Vicky Millerly Martinez - Vivienda de bahareque con múltiples afectaciones (RUFE-1591)[cite: 48].",
        "personas": [
            {"nombre": "Vicky Millerly Martinez", "doc": "432520821", "fecha": "07/12/1981", "es_jefe": True, "sexo": "F", "parentesco": "Jefe de Hogar", "etnia": "Ninguna"},
            {"nombre": "Elmy Sofia Bermudez Martinez", "doc": "1239688423", "fecha": "24/02/2023", "es_jefe": False, "sexo": "F", "parentesco": "Hijo(a)", "etnia": "Ninguna"},
            {"nombre": "Miquel Angel Martinez", "doc": "1116376398", "fecha": "13/11/2017", "es_jefe": False, "sexo": "M", "parentesco": "Hijo(a)", "etnia": "Ninguna"},
            {"nombre": "Carulinu Victor Alfonso Hurtado", "doc": "1112163024", "fecha": "19/07/2019", "es_jefe": False, "sexo": "M", "parentesco": "Hijo(a)", "etnia": "Ninguna"}
        ]
    }
]
...
def main():
    print("Iniciando ENRIQUECIMIENTO FINAL Lote 1590-1591...")
    try:
        ...
        print(f"\n==================================================")
        print(f"MIGRACIÓN LOTE 1590-1591 EXITOSA.")
