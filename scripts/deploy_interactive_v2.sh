...
# ============================================================
# Emergency Col SGRD - Despliegue Interactivo V2
# ============================================================
...
case $OPCION in
  ...
  2)
    ...
    URL_FRONTEND="http://192.168.194.1:8080"
    ;;
  3)
...
# ============================================================
echo -e "${YELLOW}🔐 Ingresa la contraseña SSH (no se mostrará mientras escribes)${NC}"
read -sp "🔑 Clave para $USUARIO@$IP: " PASS
echo ""
echo ""

read -p "¿Continuar con el despliegue? (s/n): " CONFIRMAR
...
# ============================================================
# FUNCIÓN SSH Y SCP CON EXPECT (UNA SOLA CONTRASEÑA)
# ============================================================
ssh_cmd() {
    expect -c "
        set timeout 60
...
scp_cmd() {
    expect -c "
        set timeout 60
        spawn scp -o StrictHostKeyChecking=no $1 $USUARIO@$IP:$2
        expect {
            \"password:\" { send \"$PASS\r\"; exp_continue }
            \"Password:\" { send \"$PASS\r\"; exp_continue }
            \"yes/no\" { send \"yes\r\"; exp_continue }
...
scp_cmd /tmp/web_build.tar.gz /tmp/web_build.tar.gz
...
# ============================================================
# PASO 3: PERMISOS ADICIONALES PARA PRODUCCIÓN
# ============================================================
