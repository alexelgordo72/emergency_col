...
LOTES_NUEVOS_RUFE = [
    ...
    },
    {
        ...
        "observaciones_evaluador": "Casa de los retazos - Local opera con total normalidad, sin daños físicos ni de maquinaria (RDE-1201).",
    ...
    },
    {
        ...
        "observaciones_evaluador": "Cristalería Cesitodo / Maria Eugenia Giraldo - Solo daños en alguna mercancía (RDE-1202).",
    ...
    },
    {
        ...
        "observaciones_evaluador": "Laura Sofía Sport / Maria Liliana Borrero - Negocio sin afectaciones, funcionando normalmente (RDE-1203).",
    ...
    },
    {
        ...
        "observaciones_evaluador": "Calzado Boys / Sandra Patricia Mazo - Sin daños reportados en mercancía ni local (RDE-1204).",
    ...
    },
    {
        ...
        "observaciones_evaluador": "Lex Jeans / Alexander - Ayuda en línea para aumentar las ventas tras la emergencia (RDE-1205).",
    ...
    },
    {
        ...
        "observaciones_evaluador": "Odontorent Clínica Odontológica / Yareth Muñoz - Requiere inspección técnica urgente (RDE-1207).",
    ...
    },
    {
        ...
        "observaciones_evaluador": "Muebles Bestidas / Iveth Marquez - No presenta daños en mercancía ni servicios (RDE-1208).",
    ...
    },
    {
        ...
        "observaciones_evaluador": "Papelería Miscelánea La Novena / Nelcy Triviño Silva - Sin afectaciones (RDE-1209).",
    ...
    },
    {
        ...
        "observaciones_evaluador": "Tienda Maravillas Naturales / Angela Daniela Ramos - Buen estado, operando normalmente (RDE-1210).",
    ...
    },
    {
        ...
        "observaciones_evaluador": "Meam Muebles / Maria Sirlena Duran - Solo fisuras leves en segundo piso (RDE-1211).",
    ...
    },
    {
        ...
        "observaciones_evaluador": "Grupo Empresarial Irlanda / Gil Ordoñez - Daños en infraestructura con afectación de ingresos (RDE-1212).",
    ...
    },
    {
        ...
        "observaciones_evaluador": "Panadería Nutripan / Giraldo Rodriguez - Sin afectaciones estructurales, operando normalmente (RDE-1219).",
    ...
    },
    {
        ...
        "observaciones_evaluador": "Panadería La Principal de Lleras / Gonzalo de Jesus Gomez Giraldo - Sin afectaciones, operando (RDE-1220).",
    ...
    },
    {
        ...
        "observaciones_evaluador": "Hotel Jacinto Plaza de los Ros - Daños leves en maquinaria y equipo, requiere revisión de transformador eléctrico (RDE-1225).",
    ...
    },
    {
        ...
        "observaciones_evaluador": "Grupo Comercial Astroventas / Sibeiro Mezu - Disminución temporal en ventas, operando con normalidad (RDE-1226).",
    ...
    },
    {
        ...
        "observaciones_evaluador": "Fleximax / Juan Carlos Sanchez Espinoza - Daños en infraestructura física, requiere inspección técnica (RDE-1227).",
    ...
    },
    {
        ...
        "observaciones_evaluador": "El Gangazo paisa / Julia Palma Soto - Sin afectaciones estructurales reportadas, pérdida de inventario por cristalería (RDE-1228).",
...
def main():
    print("Iniciando ENRIQUECIMIENTO FINAL Lote 1171-1230...")
    try:
        ...
        print(f"\n==================================================")
        print(f"MIGRACIÓN LOTE 1171-1230 EXITOSA.")
