...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Color _getEstadoColor(String estado) {
    ...
    if (estadoLower.contains('visitado') && estadoLower.contains('media')) return Colors.orange;
    if (estadoLower.contains('visitado') && estadoLower.contains('baja')) return Colors.green;
    if (estadoLower.contains('visitado') && estadoLower.contains('sin prioridad')) return Colors.grey;
    if (estadoLower.contains('visitado')) return Colors.purple;
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          ...
          IconButton(
            icon: const Icon(Icons.holiday_village, color: Colors.white, size: 24),
          ...
          IconButton(
            icon: const Icon(Icons.assignment_late, color: Colors.white, size: 24),
                        ...
                        : reportes.isEmpty && !cargando
                            ...
                            : ListView.builder(
                                ...
                                itemBuilder: (context, index) {
                                  ...
                                  final estado = reporte.estado ?? 'Sin estado';
