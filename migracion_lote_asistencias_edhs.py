...
LOTES_NUEVOS_RUFE = [
    # --- SANTA INÉS Y FORMATOS AHE ---
    {
        "num_formulario": "83", "corregimiento": "Santa Ines", "prioridad": "MEDIA",
        "observaciones_evaluador": "Fracturas en paredes, desprendimiento de losa en el frente, caída de techo en la parte delantera.",
        "personas": [
            {"nombre": "Leidy Montes", "doc": "29398080", "fecha": "01/01/1985", "es_jefe": True, "sexo": "F", "parentesco": "Jefe de Hogar", "etnia": "Ninguna"}
        ]
    },
    {
        "num_formulario": "84", "corregimiento": "Bolivar", "prioridad": "ALTA",
    ...
    },
    {
        ...
        "observaciones_evaluador": "Muros divisorios fracturados en el segundo piso, muy comprometidos, algunos deben demolerse y volverse a realizar.",
        "personas": [
...
def main():
    print("Iniciando ENRIQUECIMIENTO Lote 83-94 y EDHS Juan Pablo II...")
    try:
        ...
        print(f"\n==================================================")
        print(f"MIGRACIÓN LOTE 83-94 & JUAN PABLO II EXITOSA.")
